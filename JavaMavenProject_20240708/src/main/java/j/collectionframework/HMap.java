...
/*
 * key, value pairs
 * keys are unique (duplicate keys: will replace the value)
...
//		System.out.println(hm.containsValue("T"));
...
//		System.out.println(hm.navigableKeySet());
		...
		for(Integer k:hm.navigableKeySet())
		{
			...
			System.out.println(hm.get(k)); // value
		}
		
		System.out.println(hm.containsKey(3));
		System.out.println(hm.containsValue("Y"));
